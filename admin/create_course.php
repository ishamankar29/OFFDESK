...
<div class="sidebar">
  ...
  <a class="active" href="create_course.php"><i class="fa fa-book"style="font-size: 30px"></i> CREATE COURSE</a>
...
<form method="post" action="course.php">
  COURSE CODE
    <input type="text" minlength="6" maxlength="6" name="course_code" required>
    <br>
  COURSE NAME
