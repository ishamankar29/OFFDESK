...
<div class="sidebar">
  ...
  <a  class="active" href="editteacher.php"><i class='fa fa-edit' style="font-size: 30px"></i>   EDIT TEACHER</a>
...
$result = mysqli_query($con,"SELECT * FROM user_teacher");
?>
<!DOCTYPE html>
<html>
 <head>
   <title> EDIT TEACHER USERS </title>
   <link rel="stylesheet" href="style.css">
 </head>
<body>
<?php
...
@media print{
  ...
  .edit_teacher_table, .edit_teacher_table *{
    visibility: visible;
  }
.edit_teacher_table{
    position: absolute;
...
<center><table width="90%" border="1" cellspacing="0" cellpadding="1" bgcolor=white>
    ...
    <td><?php echo $row["alloted_course"]; ?></td>
        <td><a href="updateteacher.php?username=<?php echo $row["username"]; ?>">UPDATE</a></td>
        <td><a href="deleteteacher.php?username=<?php echo $row["username"]; ?>">DELETE</a></td>
      </tr>
      <?php
      $i++;
      }
