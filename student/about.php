...
<div class="sidebar">
  ...
  <a class="active" href="about.php"><i class="fa fa-users" style="font-size: 34px"></i> ABOUT</a>
...
Our mission is to reduce the manual work done by<br> teachers and students in conducting Internal Assessment </h2></br>
  <h3>
   What does OffDesk provide?  <br></br>
    * Conducting MCQ quiz       <br>
    * Grading Assignments         <br>
    * Downloading Resources      <br>
    * Centralized Data Mangement     <br>
  </h3>
