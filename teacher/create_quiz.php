...
<div class="sidebar">
  ...
  <div class="QUIZ">
    <a href="view_quiz.php"><i class="" style="font-size: 30px" ></i> VIEW QUIZZES </a>
      <a class="active" href="create_quiz.php"><i class="" style="font-size: 30px" ></i> CREATE MCQ </a>
...
<div class="content">
  ...
  <h1>CREATE QUIZ</h1>
  <left>
    <form method="post" action="createquizACTION.php">
...
Quiz Name:
    ...
    <br>
   Number Of Question:
    <input type="number" name="ques_no" required>
    <br>
    Time in Minutes:
    <input type="number" name="quiz_time" required>
    <br>
