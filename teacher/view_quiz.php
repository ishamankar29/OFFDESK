...
<div class="sidebar">
  ...
  <div class="QUIZ">
    <a class="active" href="view_quiz.php"><i class="" style="font-size: 30px" ></i> VIEW QUIZZES </a>
...
<center>
        ...
        <h1> VIEW  EXISTING QUIZZES </h1>
       

        <form method="GET" action="view_quiz.php"> 
...
//$quiz_name=$_POST["quiz_name"];
//echo $fetchquiz;
$result = mysqli_query($con,"SELECT * FROM quiz_log_table where course_code='$mycourse' order by id");
